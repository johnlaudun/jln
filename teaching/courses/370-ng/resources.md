---
title: ENGL 370 - Story Games - Resources
---
...
- Extra Credit’s advice is not to start with a complete story: [How To Start Your Game Narrative: Design Mechanics First](https://www.youtube.com/watch?v=22HoViH4vOU). (Note that this is oriented toward VRPGs.)
- Extra Credit also has a video arguing that game writing comes down to [Plot, Character, Lore](https://www.youtube.com/watch?v=wNNXdoj7cCQ).
- Adapt a game you like. [It’s what I did.]() This works for TTRPGs more than video games.
- Adam Robinson-Yu has a terrific breakdown of what it took to put *A Short Hike* together: [Crafting A Tiny Open World: A Short Hike Postmortem](https://www.youtube.com/watch?v=ZW8gWgpptI8). 
...
* Maybe all you want to do is make games: [How to Survive in Gamedev for Eleven Years Without a Hit](https://www.youtube.com/watch?v=JmwbYl6f11c). 
...
* In particular, Jurie Horneman’s 2015 session at GDC, [“The Design in Narrative Design”](https://www.youtube.com/watch?v=f8VIlfTtypg) is worth the watch. 
...
* [StoryFlow Editor](https://storyflow-editor.com/) looks interesting, and powerful (and complex), and it’s available on both Steam and [Itch.io](https://soulstices.itch.io/storyflow-editor).
* [Articy](https://www.articy.com/en/) claims that “integrating content from your narrative design tool into your game has  never been easier. Hundreds of quests, thousands of items, countless  lines of dialogue - all in your game with one click.”
* [Celtx](https://www.celtx.com/) offers “screen writing, story development, and production tools for film & TV, and interactive media.”
* [YarnSpinner](https://yarnspinner.dev/) describes itself as “Everything you need to create compelling dialogue and branching narratives, with full documentation and community support.” It has integrations for Unity, Godot, and Unreal engines. 
...
At some point, we have to deal with AI. It’s even come for TTRPGs: [Dungeons Deep](https://dungeonsdeep.ai/).

### Games to Try

* [Fallen London](https://www.fallenlondon.com/) (online). 
* cult classics and influential: *Bayonetta*, *Persona*, *Kingdom Hearts*, *Breath of the Wild*.
